...
const HouseSVGImage: HouseSVGImageComponent = () => {
	...
	return (
		<Root>
			...
			>
				<defs>
					<svg id='light' stroke='black' strokeWidth='500' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000' width='1000' height='1000'>
					...
					<svg id='ticks' stroke='black' strokeWidth='500' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000' width='1000' height='1000'>
						<g transform='translate(0.000000,512.000000) scale(0.100000,-0.100000)'>
					...
					<svg id='music-note' xmlns="http://www.w3.org/2000/svg" viewBox="35 0 149 219" width="149" height="219" fill="black">
				...
				/>
				<SVGLampIcon
					lampId={LAMP_ID_WINDOW}
					x={65}
					y={125}
				/>
				<SVGLampIcon
					lampId={LAMP_ID_MIDDLE}
					x={65}
					y={70}
				/>
				<SVGLampIcon
